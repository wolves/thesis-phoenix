...
var Net = {
  get: function get(path) {
    ...
    return Net.request(path, body, 'GET', type);
  },
  post: function post(path, body) {
    var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'json';
    return Net.request(path, body, 'POST', type);
  },
  put: function put(path, body) {
    var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'json';
    return Net.request(path, body, 'PUT', type);
  },
  patch: function patch(path, body) {
    var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'json';
    return Net.request(path, body, 'PATCH', type);
  },
  delete: function _delete(path, body) {
    var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'json';
    return Net.request(path, body, 'DELETE', type);
  },
  request: function request(path, body, method, type) {
    // headers
...
var ThesisEditor = function (_React$Component) {
  ...
  function ThesisEditor(props) {
    ...
    var _this = _possibleConstructorReturn(this, (ThesisEditor.__proto__ || Object.getPrototypeOf(ThesisEditor)).call(this, props));

    _this.state = {
      editing: false,
      path: _this.props.external.path,
      title: _this.props.external.getTitle(),
      description: _this.props.external.getDescription(),
      template: _this.props.external.template,
      templates: _this.props.external.templates,
      isDynamicPage: _this.props.external.isDynamicPage,
      redirectURL: _this.props.external.pageRedirectURL,
      pageModified: false,
      ...
      notifications: JSON.parse(_this.props.external.notifications)
    };
    ...
    // External editors
    if (_this.props.external.customHTMLEditor) {
      _this.htmlEditor = new _this.props.external.customHTMLEditor({
        onChange: function onChange() {
          return _this.setState({ pageModified: true });
        }
      });
    } else {
      _this.htmlEditor = new _html_editor2.default({
        onChange: function onChange() {
          return _this.setState({ pageModified: true });
        }
      });
    ...
    _this.rawHtmlEditor = new _raw_html_editor2.default({
      openTray: _this.openTray('raw-html'),
      closeTray: _this.trayCanceled
    });

    _this.imageEditor = new _image_editor2.default({
      ospryPublicKey: _this.props.external.ospryPublicKey,
      fileUploader: _this.props.external.fileUploader,
      openTray: _this.openTray('image-url'),
      closeTray: _this.trayCanceled
    });

    _this.textEditor = new _text_editor2.default({
      onChange: function onChange() {
        return _this.setState({ pageModified: true });
      }
    });
  ...
  _createClass(ThesisEditor, [{
    key: 'openTray',
    value: function openTray(trayType) {
      var _this2 = this;

      return function (trayData) {
        _this2.setState({
          pageModified: true,
          trayOpen: true,
          trayType: trayType,
    ...
    value: function settingsTraySubmitted(data) {
      if (data.new) {
        var page = {
          slug: data.path,
          title: data.title,
    ...
    key: 'deletePagePressed',
    value: function deletePagePressed() {
    ...
    key: 'deletePage',
    value: function deletePage(path) {
      var _this4 = this;

      this.props.external.delete(path, function () {
        _this4.setState({ deleted: true, editing: false });
      });
    }
  }, {
    key: 'importData',
    value: function importData(page, contents) {
      var _this5 = this;
      ...
      this.setState({
        ...
        for (var i = 0; i < contents.length; i++) {
          ...
          _this5.importContent(content, page);
        }

        // set a import timeout
        window.importContentCounterTimeout = setTimeout(function () {
          _this5.setState({
    ...
    key: 'importContent',
    value: function importContent(content, page) {
      var _this6 = this;

      switch (content.content_type) {
        case 'image':
        case 'background_image':
          return this.imageEditor.uploadAndSet(content, page, function () {
            _this6.updateImportedContentCompletedCount();
          });
        case 'text':
    ...
    key: 'updateImportedContentCompletedCount',
    value: function updateImportedContentCompletedCount() {
      var _this7 = this;

      this.setState(function (prevState, props) {
        var newCompletedCount = prevState.importContentCompletedCount + 1;
        if (newCompletedCount >= _this7.state.importContentQueueCount) {
    ...
    value: function updateImportProgress(progress) {
      this.setState({ importProgress: progress });
    }
  }, {
    key: 'checkForDuplicateContentBlocks',
    value: function checkForDuplicateContentBlocks() {
      var editors = this.allContentEditors();

      var names = {};
      for (var i = 0; i < editors.length; i++) {
        var name = editors[i].dataset.thesisContentId;
        names[name] = names[name] ? names[name] + 1 : 1;
      }

      var duplicateIndex = Object.values(names).findIndex(function (value) {
        return value > 1;
      });

      if (duplicateIndex > 0) {
        var key = Object.keys(names)[duplicateIndex];
    ...
    key: 'editorClassButtonCount',
    value: function editorClassButtonCount() {
      var count = 5;
    ...
    key: 'parseNotifications',
    value: function parseNotifications(type) {
    ...
    value: function render() {
      if (this.state.deleted) {
        return _react2.default.createElement('div', { id: 'thesis' });
      }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.canCreatePages() ? _react2.default.createElement(_add_button2.default, { onPress: this.addPagePressed }) : null,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_tray_notifications2.default, { notifications: this.parseNotifications(this.state.trayType) }),
          this.renderTray(),
...
var external = function external(container) {
  var descriptionMetaTag = document.querySelectorAll('meta[name=description]')[0];
  return {
    ...
    templates: container.getAttribute('data-templates').split(',').filter(function (s) {
      return s !== '';
    }),
    ...
    getDescription: function getDescription() {
      return descriptionMetaTag && descriptionMetaTag.content;
    },
    setDescription: function setDescription(desc) {
      return descriptionMetaTag && (descriptionMetaTag.content = desc);
    },
    getRedirectURL: function getRedirectURL() {
      return container.getAttribute('data-redirect-url');
    },
    ...
    delete: function _delete(path, callback) {
      _net2.default.delete('/thesis/delete', { path: path }).then(function (resp) {
...
var AttributionText = function (_React$Component) {
  ...
  function AttributionText() {
    ...
    return _possibleConstructorReturn(this, (AttributionText.__proto__ || Object.getPrototypeOf(AttributionText)).apply(this, arguments));
  }
...
var DeleteButton = function (_React$Component) {
  ...
  _createClass(DeleteButton, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { onClick: this.props.onPress, className: 'thesis-button delete' },
        _react2.default.createElement(
          'div',
          { className: 'tooltip' },
          'Delete This Page'
...
var ImportExportRestoreButton = function (_React$Component) {
  ...
  _createClass(ImportExportRestoreButton, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { onClick: this.props.onPress, className: 'thesis-button import-export' },
        _react2.default.createElement(
          'div',
          { className: 'tooltip' },
          'Import/Export/Restore Content'
        ),
        _react2.default.createElement('i', { className: 'fa fa-exchange fa-2x' })
      );
    }
  }]);
...
var _reactCopyToClipboard = __webpack_require__(42);
...
var ImportExportRestoreTray = function (_React$Component) {
  ...
  function ImportExportRestoreTray(props) {
    ...
    _this.onExportCopy = _this.onExportCopy.bind(_this);
    _this.stringifyExportData = _this.stringifyExportData.bind(_this);
    _this.onImportDataPaste = _this.onImportDataPaste.bind(_this);
    _this.onImportApply = _this.onImportApply.bind(_this);
    _this.onRevisionSelect = _this.onRevisionSelect.bind(_this);
    return _this;
  }
  ...
  _createClass(ImportExportRestoreTray, [{
    ...
    key: 'onExportCopy',
    value: function onExportCopy() {
      var _this2 = this;

      this.setState({ exportDataButtonText: 'Copied!' });

      clearTimeout(window.exportDataButtonTextTimeout);
      window.exportDataButtonTextTimeout = setTimeout(function () {
        _this2.setState({ exportDataButtonText: 'Copy to Clipboard' });
      }, 2000);
    }
  }, {
    key: 'stringifyExportData',
    value: function stringifyExportData() {
      var exportData = {
        pageSettings: Object.assign({}, this.props.pageSettings, { origin: window.location.origin }),
        pageContents: this.props.pageContents
      };

      var stringifiedExportData = JSON.stringify(exportData);

      this.setState({ stringifiedExportData: stringifiedExportData });
    }
  }, {
    key: 'onImportDataPaste',
    value: function onImportDataPaste(e) {
      this.setState({ stringifiedImportData: e.target.value });
    }
  }, {
    key: 'onImportApply',
    value: function onImportApply() {
    ...
    key: 'getImportData',
    value: function getImportData() {
      var importData = this.parseStringifiedImportData();
      return importData && importData.pageSettings && importData.pageContents ? importData : null;
    }
  }, {
    key: 'getPageRevisions',
    value: function getPageRevisions() {
      var _this3 = this;

      var pageSlug = this.props.pageSettings.slug;

      _net2.default.get('/thesis/backups?page_slug=' + pageSlug, null, 'query').then(function (data) {
        _this3.setState({ revisions: data });
      }).catch(function (error) {
        window.alert(error);
      });
    }
  }, {
    key: 'parseStringifiedImportData',
    value: function parseStringifiedImportData() {
      try {
    ...
    key: 'setImportProgressError',
    value: function setImportProgressError(error) {
      var _this4 = this;

      this.props.updateImportProgress(error);

      clearTimeout(window.importProgressErrorTimeout);
      window.importProgressErrorTimeout = setTimeout(function () {
        _this4.props.updateImportProgress(null);
        _this4.setState({ stringifiedImportData: '' });
      }, 3500);
    }
  }, {
    key: 'prettyRevisionName',
    value: function prettyRevisionName(rev) {
      return 'Rev ' + rev.page_revision + ' made on ' + rev.pretty_date;
    }
  }, {
    key: 'onRevisionSelect',
    value: function onRevisionSelect(e) {
      var _this5 = this;

      _net2.default.get('/thesis/restore/' + e.target.value, null, 'query').then(function (data) {
        _this5.setState({ stringifiedImportData: data.revision });
      }).catch(function (error) {
        window.alert(error);
      });
    }
    ...
    key: 'renderImportExportActions',
    value: function renderImportExportActions() {
      var _this6 = this;
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('textarea', { value: this.state.stringifiedExportData, className: 'thesis-tray-export-data-textarea', readOnly: true }),
              _react2.default.createElement(
                _reactCopyToClipboard2.default,
                { text: this.state.stringifiedExportData, onCopy: this.onExportCopy },
                _react2.default.createElement(
                  'button',
                  { className: 'thesis-tray-export' },
                  this.state.exportDataButtonText
                )
              )
            )
          ),
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('textarea', { placeholder: 'Paste the exported data here.', className: 'thesis-tray-import-data-textarea', onChange: this.onImportDataPaste, value: this.state.stringifiedImportData })
            )
          ),
          _react2.default.createElement('br', null),
          _react2.default.createElement('br', null),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'select',
                  { value: 'placeholder', onChange: this.onRevisionSelect },
                  _react2.default.createElement(
                    'option',
                  ...
                  this.state.revisions.map(function (revision) {
                    return _react2.default.createElement(
                      ...
                      _this6.prettyRevisionName(revision)
                    );
                  })
                )
              )
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: 'thesis-tray-save', onClick: this.onImportApply },
              'Import'
            )
          )
        )
    ...
    key: 'renderImportStatus',
    value: function renderImportStatus() {
      return _react2.default.createElement(
        'div',
        { className: 'tray-container' },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'thesis-tray-import-progress ' + this.props.importProgress.type },
            _react2.default.createElement(
              'div',
              { className: 'thesis-tray-loader' },
              _react2.default.createElement('span', null)
            ),
            _react2.default.createElement(
              'div',
              { className: 'thesis-tray-import-status' },
              this.props.importProgress.text
            )
          )
        )
      );
...
var SettingsTray = function (_React$Component) {
  ...
  function SettingsTray(props) {
    ...
    var _this = _possibleConstructorReturn(this, (SettingsTray.__proto__ || Object.getPrototypeOf(SettingsTray)).call(this, props));

    var template = props.template || props.new && props.templates[0] || null;
    ...
    _this.redirectURLChange = _this.redirectURLChange.bind(_this);
    _this.pathChange = _this.pathChange.bind(_this);
    _this.templateChange = _this.templateChange.bind(_this);
  ...
  _createClass(SettingsTray, [{
    ...
    key: 'redirectURLChange',
    value: function redirectURLChange(event) {
      this.setState({ redirectURL: event.target.value });
    }
  }, {
    key: 'pathChange',
    value: function pathChange(event) {
      this.setState({ path: event.target.value });
    }
  }, {
    key: 'templateChange',
    value: function templateChange(event) {
    ...
    key: 'isDynamicPage',
    value: function isDynamicPage() {
      return this.props.new || this.state.isDynamicPage;
    }
  }, {
    key: 'prettyTemplateName',
    value: function prettyTemplateName(name) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'select',
              { value: this.state.template, onChange: this.templateChange },
              this.state.templates.map(function (template) {
                return _react2.default.createElement(
                  'option',
                  { value: template },
                  _this2.prettyTemplateName(template)
                );
              })
            )
          )
    ...
    value: function renderRedirectURL() {
      return _react2.default.createElement(
        'div',
        { className: 'thesis-field-row' },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'span',
            null,
            'Redirect URL (leave blank for none)'
          ),
          _react2.default.createElement('input', { type: 'text', value: this.state.redirectURL, onChange: this.redirectURLChange })
        )
      );
    }
  }, {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('input', { type: 'text', value: this.state.path, disabled: !this.isDynamicPage(), onChange: this.pathChange, className: 'page-path' })
            )
          ),
          _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('input', { type: 'text', placeholder: 'Example Title', value: this.state.title, onChange: this.titleChange, className: 'page-title' })
            )
          ),
          _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('textarea', { placeholder: 'Example page description.', value: this.state.description, onChange: this.descriptionChange, className: 'page-description' })
            )
          ),
...
var TrayNotifications = function (_React$Component) {
  _inherits(TrayNotifications, _React$Component);

  function TrayNotifications(props) {
    _classCallCheck(this, TrayNotifications);

    return _possibleConstructorReturn(this, (TrayNotifications.__proto__ || Object.getPrototypeOf(TrayNotifications)).call(this, props));
  }

  _createClass(TrayNotifications, [{
    ...
    value: function renderNotifications() {
      ...
      return this.props.notifications.map(function (n) {
        return _react2.default.createElement(
          'div',
          { className: 'thesis-tray-notification' },
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'thesis-tray-notifications' },
        _react2.default.createElement(
          'div',
          { className: 'thesis-tray-notifications-wrap' },
...
exports.default = TrayNotifications;
...
var _mediumEditor = __webpack_require__(35);
...
var HtmlEditor = function () {
  ...
  _createClass(HtmlEditor, [{
    ...
    value: function set(name, data) {
      var ed = document.querySelector('[data-thesis-content-id=\'' + name + '\']');
      if (!ed) return;
    ...
    value: function mediumEditorOptions() {
      ...
      return {
        autoLink: true,
        toolbar: {
          buttons: ['bold', 'italic', 'underline', 'anchor', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'quote', 'orderedlist', 'unorderedlist', 'removeFormat', 'justifyLeft', 'justifyCenter', 'justifyRight'],
          static: true,
          align: 'center',
          sticky: true,
...
var _image_tray = __webpack_require__(25);
...
var ImageEditor = function () {
  ...
  _createClass(ImageEditor, [{
    ...
    key: 'uploadAndSet',
    value: function uploadAndSet(data, page, callback) {
      var _this = this;

      var image = this.determineImageUrl(data.content, page.origin);
      var editor = document.querySelector('[data-thesis-content-id="' + data.name + '"');
      ...
      if (!image.upload) {
        ...
        _net2.default.post('/thesis/files/import', { image_url: image.imageUrl, image_name: data.name }).then(function (response) {
          callback();
          if (response.path.length > 0) _this.set(data.name, { url: response.path }, data.meta);
        }).catch(function (error) {
          callback();window.alert(data.name + ' could not be saved.');
        });
      }
    }
  }, {
    ...
    value: function set(name, data) {
      ...
      var editor = document.querySelector('[data-thesis-content-id="' + name + '"');
      editor.classList.add('modified');

      if (!meta) {
        var prevMeta = JSON.parse(editor.getAttribute('data-thesis-content-meta'));
        var newMeta = Object.assign({}, prevMeta, { alt: data.alt });
    ...
    key: 'determineImageUrl',
    value: function determineImageUrl(image, origin) {
      if (image.trim() === '') {
        return null;
    ...
    key: 'isImageAbsoluteUrl',
    value: function isImageAbsoluteUrl(image) {
      var index = image.trim().indexOf('//');
      return index > 4 && index < 7;
    }
  }, {
    key: 'isImageUrlWithoutProtocol',
    value: function isImageUrlWithoutProtocol(image) {
      var index = image.trim().indexOf('//');
      return index === 0;
    }
  }, {
...
var _ospry = __webpack_require__(30);

var _ospry2 = _interopRequireDefault(_ospry);
...
var Ospry = (0, _ospry2.default)(window);
...
var ImageTray = function (_React$Component) {
  ...
  function ImageTray(props) {
    ...
    var _this = _possibleConstructorReturn(this, (ImageTray.__proto__ || Object.getPrototypeOf(ImageTray)).call(this, props));
    ...
    _this.onOspryUpload = _this.onOspryUpload.bind(_this);

    _this.uploadFile = _this.uploadFile.bind(_this);
    _this.uploadFileToOspry = _this.uploadFileToOspry.bind(_this);

    _this.renderForm = _this.renderForm.bind(_this);
    _this.renderOspryForm = _this.renderOspryForm.bind(_this);
    _this.renderUploaderForm = _this.renderUploaderForm.bind(_this);

    _this.onCancel = props.onCancel;
    return _this;
  }
  ...
  _createClass(ImageTray, [{
    ...
    key: 'onOspryUpload',
    value: function onOspryUpload(err, metadata) {
    ...
    value: function uploadFile(e) {
      ...
      e.preventDefault();
      _net2.default.post('/thesis/files/upload', e.target.form, 'form').then(function (response) {
        if (response.path.length > 0) _this2.setState({ url: response.path });
      }).catch(function (error) {
        window.alert(error);
      });
    }
  }, {
    key: 'uploadFileToOspry',
    value: function uploadFileToOspry(e) {
      this.setState({ fileName: e.target.files[0].name });

      var ospry = new Ospry(this.props.ospryPublicKey);
    ...
    key: 'renderUploaderForm',
    value: function renderUploaderForm() {
      return _react2.default.createElement(
        'div',
        { className: 'thesis-field-row' },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'form',
            { onChange: this.uploadFile, className: 'tray-file-upload' },
            _react2.default.createElement(
              'span',
              null,
              this.state.fileName
            ),
            _react2.default.createElement('input', { type: 'file', accept: '.svg,image/*', name: 'file' })
          )
        )
      );
    }
    ...
    key: 'renderOspryForm',
    value: function renderOspryForm() {
      if (this.props.ospryPublicKey) {
        return _react2.default.createElement(
          'div',
          { className: 'thesis-field-row' },
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'form',
              { onChange: this.uploadFileToOspry, className: 'tray-file-upload' },
              _react2.default.createElement(
                'span',
                null,
                this.state.fileName
              ),
              _react2.default.createElement('input', { type: 'file', accept: '.jpg,.jpeg,.png,.gif,image/png,image/gif,image/jpeg,image/jpg' })
            )
          )
        );
      }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: 'thesis-tray-cancel', onClick: this.onCancel },
              'Cancel'
            ),
            _react2.default.createElement(
              'button',
...
var _raw_html_tray = __webpack_require__(27);
...
var RawHtmlTray = function (_React$Component) {
  ...
  function RawHtmlTray(props) {
    ...
    var _this = _possibleConstructorReturn(this, (RawHtmlTray.__proto__ || Object.getPrototypeOf(RawHtmlTray)).call(this, props));
...
var _thesisEditor = __webpack_require__(9);

var _thesisEditor2 = _interopRequireDefault(_thesisEditor);

var _external = __webpack_require__(10);
...
var thesis = function thesis(container) {
  ...
  var ext = (0, _external2.default)(container);

  return _reactDom2.default.render(_react2.default.createElement(_thesisEditor2.default, { external: ext }), container);
};
...
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; // @preserve Copyright 2014 Ospry Labs, LLC. All rights reserved.


exports.default = function (e) {
  "use strict";
  var t = "FormData" in e && "XMLHttpRequest" in e && "withCredentials" in new XMLHttpRequest(),
      r = function r(e) {
    return "object" == (typeof e === "undefined" ? "undefined" : _typeof(e)) && null !== e && !(e instanceof Array);
  },
      n = function n(e) {
    ...
    var r = {};for (var n in t) {
      t.hasOwnProperty(n) && (r[n] = "undefined" == typeof e[n] ? t[n] : e[n]);
    }return r;
  },
      s = function s(e) {
    if ("input" === e.nodeName.toLowerCase() && "file" === e.type.toLowerCase()) return e;for (var t = e.children, r = 0; r < t.length; r++) {
      var n = s(t[r]);if (null !== n) return n;
    }return null;
  },
      u = function u(e, t, r) {
    ...
    for (var t = "", r = 0; e > r; r++) {
      ...
      m = function m(e) {
    if (!o(e)) throw "ospry: required public key is not a string";if ("" === e) throw "ospry: required public key is missing";this._key = e, this._serverURL = "https://api.ospry.io/v1";
  };m.formats = ["jpeg", "png", "gif"], m.prototype.up = function (e) {
    if (!r(e)) throw "ospry: required options argument is not an object";if (e = a(e, { files: null, form: null, isPrivate: !1, imageReady: i, done: i }), t) {
      if (null === e.files) {
        if (null === e.form) throw "ospry: both form and files are missing from options (one of them should be set)";var n = s(e.form);if (null === n) throw "ospry: file input is missing from form";e.files = n.files;
      }this._upXHR(e.files, e);
    } else {
      if (null === e.form) throw "ospry: form property is missing from options (older browsers only support form-based uploads)";this._upIFrame(e);
    }
  }, m.prototype._upXHR = function (e, t) {
    for (var r = 0, n = function n(_n, o, i) {
      t.imageReady(_n, o, i), r++, r === e.length && t.done();
    }, o = 0; o < e.length; o++) {
      this._upXHRFile(e[o], t, o, n);
    }
  }, m.prototype._upXHRFile = function (e, t, r, n) {
    var o = new FormData();o.append("key", this._key), o.append("isPrivate", t.isPrivate), o.append("file", e);var i = new XMLHttpRequest();i.onerror = function () {
      var e = { httpStatusCode: 0, cause: "network-error", message: "Network error.", docsUrl: "https://ospry.io/docs#network-error" };n(e, null, r);
    }, i.onload = function () {
      var e = JSON.parse(i.responseText);if (e.hasOwnProperty("error")) return void n(e.error, null, r);var t = e.results[0];if (t.hasOwnProperty("error")) return void n(t.error, null, r);var o = t.metadata;o.hasOwnProperty("timeCreated") && (o.timeCreated = new Date(o.timeCreated)), n(null, o, r);
    }, i.open("POST", this._serverURL + "/images", !0), i.send(o);
  }, m.prototype._upIFrame = function (t) {
    var r = s(t.form);if (null === r) throw "ospry: file input is missing from form";var n = r.getAttribute("name");r.setAttribute("name", "file");var o = "ospry-" + f(24),
        i = document.createElement("iframe");i.id = o, i.name = o, i.style.display = "none", document.body.appendChild(i);var a = this._serverURL + "/images?frameId=" + encodeURIComponent(o),
        d = document.createElement("form");d.setAttribute("method", "POST"), d.setAttribute("action", a), d.setAttribute("target", o), d.setAttribute("enctype", "multipart/form-data"), d.setAttribute("encoding", "multipart/form-data"), d.style.display = "none", document.body.appendChild(d);var m = document.createElement("input");m.setAttribute("name", "key"), m.setAttribute("type", "hidden"), m.setAttribute("value", this._key);var p = document.createElement("input");p.setAttribute("name", "iframe"), p.setAttribute("type", "hidden"), p.setAttribute("value", "true");var h = document.createElement("input");h.setAttribute("name", "isPrivate"), h.setAttribute("type", "hidden"), h.setAttribute("value", t.isPrivate), d.appendChild(m), d.appendChild(p);var c = r.previousSibling;d.appendChild(r);var y = setTimeout(function () {
      document.body.removeChild(i), t.done();
    }, 6e4),
        v = function v(r) {
      if (r.source === i.contentWindow) {
        clearTimeout(y), document.body.removeChild(d), document.body.removeChild(i), l(e, "message", v);var n = JSON.parse(r.data);if (n.hasOwnProperty("error")) return void t.done();for (var o = n.results, a = 0; a < o.length; a++) {
          var s = o[a];if (s.hasOwnProperty("error")) t.imageReady(s.error, null, a);else {
            var u = s.metadata;u.hasOwnProperty("timeCreated") && (u.timeCreated = new Date(u.timeCreated)), t.imageReady(null, u, a);
          }
        }t.done();
      }
    };u(e, "message", v), d.submit(), null !== n && "" !== n ? r.setAttribute("name", n) : r.removeAttribute("name"), null !== c ? c.parentNode.insertBefore(r, c.nextSibling) : t.form.insertBefore(r, t.form.firstChild);
  }, m.prototype.get = function (e) {
    if (!r(e)) throw "ospry: required options argument is not an object";if (e = a(e, { url: null, urls: null, format: null, maxWidth: null, maxHeight: null, preload: !0, imageReady: i, done: i }), null !== e.url && (e.urls = [e.url]), null === e.urls) throw "ospry: no urls provided in options";if (0 === e.urls.length) return void e.done();for (var t = 0, n = function n(r, _n2, o) {
      e.imageReady(r, _n2, o), t++, t === e.urls.length && e.done();
    }, o = function o(e, t) {
      return function () {
        var r = { httpStatusCode: 0, cause: "image-load-error", message: "Failed to load image.", docsUrl: "https://ospry.io/docs#image-load-error" };n(r, e, t);
      };
    }, s = function s(e, t) {
      return function () {
        n(null, e, t);
      };
    }, u = 0; u < e.urls.length; u++) {
      var l = new Image();e.preload && (l.onerror = o(l, u), l.onload = s(l, u)), l.src = this.formatURL(e.urls[u], e), e.preload || n(null, l, u);
    }
  }, m.prototype.formatURL = function (e, t) {
    if (!o(e)) throw "ospry: required url is not a string";if ("undefined" == typeof t && (t = {}), !r(t)) throw "ospry: options argument is not an object";if (t = a(t, { format: null, maxWidth: null, maxHeight: null }), null === t.format && null === t.maxWidth && null === t.maxHeight) return e;var i = p.parse(e);if (null === i) throw "ospry: invalid url";if (null !== t.format) {
      if (!o(t.format)) throw "ospry: format should be a string";if ("" !== t.format) {
        "jpg" === t.format && (t.format = "jpeg");for (var s = !1, u = 0; u < m.formats.length; u++) {
          if (m.formats[u] === t.format) {
            s = !0;break;
          }
        }if (!s) throw "ospry: invalid format";i.set("format", t.format);
      } else i.remove("format");
    }if (null !== t.maxHeight) {
      if (!n(t.maxHeight)) throw "ospry: maxHeight should be a number";t.maxHeight > 0 ? i.set("maxHeight", t.maxHeight) : i.remove("maxHeight");
    }if (null !== t.maxWidth) {
      if (!n(t.maxWidth)) throw "ospry: maxWidth should be a number";t.maxWidth > 0 ? i.set("maxWidth", t.maxWidth) : i.remove("maxWidth");
    }return i.toString();
  };var p = function p() {
    this.scheme = null, this.host = null, this.path = null, this.query = {};
  };p.parse = function (e) {
    var t = new p(),
        r = e.indexOf(":");if (-1 === r) return null;t.scheme = e.slice(0, r), r += "://".length;var n = e.indexOf("/", r);if (-1 === n) return null;t.host = e.slice(r, n);var o = e.indexOf("?", n);if (-1 === o && (o = e.length), t.path = e.slice(n, o), o !== e.length) for (var i = e.slice(o + 1).split("&"), a = 0; a < i.length; a++) {
      var s = i[a],
          u = s.split("=");if (2 !== u.length) return null;t.add(decodeURIComponent(u[0]), decodeURIComponent(u[1]));
    }return t;
  }, p.prototype.set = function (e, t) {
    this.query[e] = [t];
  }, p.prototype.add = function (e, t) {
    this.query.hasOwnProperty(e) ? this.query[e].push(t) : this.query[e] = [t];
  }, p.prototype.remove = function (e) {
    delete this.query[e];
  }, p.prototype.toString = function () {
    var e = "";null !== this.scheme && (e += this.scheme + "://"), null !== this.host && (e += this.host), null !== this.path && (e += this.path);var t = this.query,
        r = [];for (var n in t) {
      t.hasOwnProperty(n) && r.push(n);
    }r.sort();for (var o = !0, i = 0; i < r.length; i++) {
      for (var n = r[i], a = t[n], s = 0; s < a.length; s++) {
        o ? (e += "?" + encodeURIComponent(n) + "=" + encodeURIComponent(a[s]), o = !1) : e += "&" + encodeURIComponent(n) + "=" + encodeURIComponent(a[s]);
      }
    }return e;
  }, "undefined" != typeof module && "undefined" != typeof module.exports ? module.exports = m : "function" == typeof e.define && e.define.amd ? e.define("Ospry", function () {
    return m;
  }) : e.Ospry = m;return m;
};
...
var deselectCurrent = __webpack_require__(43);
...
var _copyToClipboard = __webpack_require__(31);
...
if (!window.fetch) window.fetch = __webpack_require__(8).default || __webpack_require__(8);
