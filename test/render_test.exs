defmodule RenderTest do
  ...
  test "Render html content" do
    ...
    assert Render.render_editable(pc) == {:safe,
      "  <div class=\"thesis-content thesis-content-html\" data-thesis-content-type=\"html\" data-thesis-content-id=\"T\">\n    <h1>Nonsensical.</h1>\n  </div>\n"
    }
  end
  ...
  test "Render text content" do
    ...
    assert Render.render_editable(pc) == {:safe,
      "  <div class=\"thesis-content thesis-content-text\" data-thesis-content-type=\"text\" data-thesis-content-id=\"P\">\n    Plain text &lt;p&gt;Whoops&lt;/p&gt;\n  </div>\n"
    }
  end
  ...
  test "Render image content" do
    ...
    assert Render.render_editable(pc) == {:safe,
      "  <div class=\"thesis-content thesis-content-image\" data-thesis-content-type=\"image\" data-thesis-content-id=\"Img\">\n    <img src=\"http://placekitten.com/200/300\" >\n  </div>\n"
    }
  end
